...
const CreateVictim = () => {
	...
	const handleSubmit = async () => {
		...
		try {
			...
			Alert.alert(
				'Erro',
				err.response?.data?.message || 'Algo deu errado.'
			);
		...
		<ScrollView style={styles.container}>
			...
			<Picker
				...
				onValueChange={value => {
					...
					setStatus(
						value === 'IDENTIFICADO' ||
							value === 'PARCIALMENTE IDENTIFICADO'
					);
				}}
				style={styles.input}
			>
				...
				<Picker.Item
					label="PARCIALMENTE IDENTIFICADO"
					value="PARCIALMENTE IDENTIFICADO"
				/>
			</Picker>
			...
			{status && (
				<>
					...
					<TextInput
						...
						onChangeText={value =>
							handleChange('location.zipCode', value)
						}
					/>
					<TextInput
						style={styles.input}
						...
						onChangeText={value =>
							handleChange('location.street', value)
						}
					/>
					<TextInput
						style={styles.input}
						...
						onChangeText={value =>
							handleChange('location.houseNumber', value)
						}
					/>
					<TextInput
						style={styles.input}
					...
					<TextInput
						...
						onChangeText={value =>
							handleChange('location.state', value)
						}
					/>
					<TextInput
						style={styles.input}
						...
						onChangeText={value =>
							handleChange('location.complement', value)
						}
					/>
			...
			<Button
				...
				style={styles.button}
				buttonColor="#012130" // Use buttonColor aqui!
			>
				Cadastrar Vítima
			</Button>
		</ScrollView>
