...
export default function LaudoForm() {
    ...
    const handleSubmit = async () => {
        Dialog.show({
            ...
            textBody: 'Você não poderá editar ou remover o laudo depois de salvo!',
            button: 'Cancelar',
            buttons: [
                {
    ...
    return (
        ...
        >
            <ScrollView contentContainerStyle={styles.container}>
                <Text style={styles.title}>Gerar Laudo da Evidência</Text>
                ...
                <View style={styles.evidenceInfo}>
                    ...
                    <Text style={styles.info}>
                        <Text style={styles.label}>Título:</Text> {evidence?.title}
                    </Text>
                    <Text style={styles.info}>
                        <Text style={styles.label}>Relatos/Depoimentos Testemunhais:</Text>{' '}
                        {evidence?.testimony}
                    </Text>
                    <Text style={styles.info}>
                    ...
                    <Text style={styles.info}>
                        <Text style={styles.label}>Condição:</Text> {evidence?.condition}
                    </Text>
                    <Text style={styles.info}>
                        <Text style={styles.label}>Categoria:</Text> {evidence?.category}
                    </Text>
                </View>
